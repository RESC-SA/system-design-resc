...
class SolarThemeExtension extends ThemeExtension<SolarThemeExtension> {
  final Color primary;
  final Color surface;
  ...
  static const defaultLight = SolarThemeExtension(
  ...
  static const defaultDark = SolarThemeExtension(
    primary: Color(0xFF52bc49),
  ...
  @override
  SolarThemeExtension lerp(covariant SolarThemeExtension other, double t) {
    return SolarThemeExtension(
