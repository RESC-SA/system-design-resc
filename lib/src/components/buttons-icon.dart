...
/// Round or square icon-only button with optional neon glow.
/// Perfect for Bluetooth actions, refresh, delete, and toolbar icons.
...
/// Flat text-only button — for "Cancel", "Skip", "Forgot password" links.
...
/// Bordered outlined button — secondary CTA or alternative actions.
...
/// Floating action button with optional label and pulse animation.
/// Use for primary page actions like "New Scan", "Connect", "Refresh".
...
/// Two-state toggle row button — used for ON/OFF hardware parameter rows.
